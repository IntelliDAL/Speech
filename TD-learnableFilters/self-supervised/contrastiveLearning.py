...
from simsiam import SimSiam, codeDiscriminator
import torch
...
def Run(args, data):
    for train_idx in range(1):
        ...
        torch.save(trained_model.encoder.EncoderI.state_dict(),'/home/idal-01/code/TD-learnableFilters/self-supervised/pre-trained_model/EncoderI.pt')
        torch.save(trained_model.encoder.EncoderT.state_dict(),'/home/idal-01/code/TD-learnableFilters/self-supervised/pre-trained_model/EncoderT.pt')
        print('Finishing..........')
