...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=2, zero_init_residual=False, groups=1, width_per_group=64, replace_stride_with_dilation=None,
                 norm_layer=None):
        ...
        self.conv1 = nn.Conv1d(64, self.inplanes, kernel_size=7, stride=2, padding=3, bias=False)
