...
def train(args, train_dataset, AudioSpecFeat, validate_dataset, CE_weights, train_idx):
    ...
    optim_scheduler1 = torch.optim.lr_scheduler.StepLR(optimizer=optimizer1, step_size=10, gamma=0.95)
    ...
    for epoch in range(args.num_epochs):
        ...
        for batch_idx, batch_data in Loop:
            ...
            print([round(num, 4) for num in (AudioSpecFeat.AudioSpectral.FD_Learned_Filters.w[:, 0]).tolist()])  # 上分支
            # print('\n')
