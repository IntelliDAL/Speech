...
class AudioSpectral(nn.Module):
    def __init__(self, args):
        ...
        # ---------------------------
        # 结果非线性变换
        self.compression_PCEN = postprocessing.PCENLayer(self.filter_num, alpha=0.98, smooth_coef=0.04, delta=2.0, floor=1e-12, trainable=True, learn_smooth_coef=True, per_channel_smooth_coef=True)
