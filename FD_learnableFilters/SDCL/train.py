...
import torch
from SDCL.SSL_CD import SimSiam, codeDiscriminator
...
def Run(args, data):
    for train_idx in range(1):
        ...
        torch.save(trained_model.encoder.EncoderI.state_dict(),'/home/idal-01/code/TD-learnableFilters/SDCL/pre-trained_model/Encoder_'+str(args.num_epochs)+'_I.pt')
        torch.save(trained_model.encoder.EncoderT.state_dict(),'/home/idal-01/code/TD-learnableFilters/SDCL/pre-trained_model/Encoder_'+str(args.num_epochs)+'_T.pt')
        torch.save(trained_model.Extractor_I.state_dict(),'/home/idal-01/code/TD-learnableFilters/SDCL/pre-trained_model/Extractor_'+str(args.num_epochs)+'_I.pt')
        torch.save(trained_model.Extractor_T.state_dict(),'/home/idal-01/code/TD-learnableFilters/SDCL/pre-trained_model/Extractor_'+str(args.num_epochs)+'_T.pt')
        print('Finishing..........')
