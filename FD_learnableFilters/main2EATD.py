...
from untils import dataprogress, total_dataloader, dataloaderEATD, saveList, mean_sd, dataprogress2, dataprogress3
import datetime
...
def run(args):
    ...
    trainList_dataloader, testList_dataloader, valList_dataloader, toPersonList, CE_weights = dataloaderEATD(args, data, Labels)
    ...
    for train_idx in range(3):
        ...
        ckpt_path = None
        # ckpt_path = '/home/idal-01/code/TD-learnableFilters/SDCL/backup/Encoder_100_I.pt'
        ...
        if result_R['F1_w'] >= result_L['F1_w']:
...
def main():
    ...
    parser.add_argument('--experiment', type=str, default='EATD')
